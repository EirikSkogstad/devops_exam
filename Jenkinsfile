        ...
        stage('Deploy image to Google cloud') {
            steps {
                dir('devopsexam') {
                    ...
                    sh('gcloud container clusters get-credentials devops-kubernetes-cluster3 --zone europe-west3-a --project lyrical-brook-181709')

                    sh("kubectl run devops-kubernetes-cluster3 --image eu.gcr.io/lyrical-brook-181709/devopsexam:75 --port=80")
